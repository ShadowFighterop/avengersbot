...
from personalBot.Config import Config
from personalBot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
bot = "@MissRose_bot"
personal_logo = "./personal/personalBot_logo.jpg"
# Keep all credits pls
# madewith great effort by @HeisenbergTheDanger
# modified by @Kraken_The_BadAss for fbans


@personalBot.on(admin_cmd(pattern="fban ?(.*)"))
@personalBot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@personalBot.on(admin_cmd(pattern="unfban ?(.*)"))
@personalBot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@personalBot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@personalBot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@personalBot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="fgroups"))
@personalBot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="fsearch ?(.*)"))
@personalBot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@personalBot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {personal_input}")
...
@personalBot.on(admin_cmd(pattern="renamefed ?(.*)"))
@personalBot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    personal_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {personal_input}")
              response = await response 
          except YouBlockedUserError: 
...
@personalBot.on(admin_cmd(pattern="fstat ?(.*)"))
@personalBot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    personal = await event.edit("`Collecting fstat....`")
    thumb = personal_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await personalBot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using personalBot](t.me/personalUserbot) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await personal.edit("`Please Unblock` @MissRose_Bot")


@personalBot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@personalBot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    personal = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await personal.edit(massive.text + "\n\n**LEGENDARY_AF_personalBot**")
        except YouBlockedUserError:
            await personal.edit("`Please Unblock` @MissRose_Bot")

...
@personalBot.on(admin_cmd(pattern=r"unpack", outgoing=True))
@personalBot.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@personalBot.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@personalBot.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):

...
from userbot import bot as personalBot


@personalBot.on(admin_cmd(pattern="sin ?(.*)"))
@personalBot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="cos ?(.*)"))
@personalBot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="tan ?(.*)"))
@personalBot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="cosec ?(.*)"))
@personalBot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="sec ?(.*)"))
@personalBot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="cot ?(.*)"))
@personalBot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="square ?(.*)"))
@personalBot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern="cube ?(.*)"))
@personalBot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))

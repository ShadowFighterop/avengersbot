...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](personalNetwork/personalBot)**",
        ...
        "__INFO:personalBot:Logged in as 557667062__",
        "__INFO:personalBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]

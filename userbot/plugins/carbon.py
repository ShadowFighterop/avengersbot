...
async def carbon_api(e):
    ...
    personal = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    driver.get(url)
    await personal.edit("`Be Patient...\n50%`")
    download_path = "./"
    ...
    await personal.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await personal.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await personal.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by personalBot",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    personal = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await personal.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    personal = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await personal.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await personal.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await personal.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await personal.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await personal.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await personal.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await personal.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await personal.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await personal.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await personal.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await personal.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await personal.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await personal.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",

...
@personalBot.on(admin_cmd(pattern="install$", outgoing=True))
@personalBot.on(sudo_cmd(pattern="install$", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern=r"uninstall (?P<shortname>\w+)", outgoing=True))
@personalBot.on(sudo_cmd(pattern=r"uninstall (?P<shortname>\w+)", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern=r"unload (?P<shortname>\w+)$"))
@personalBot.on(sudo_cmd(pattern=r"upload (?P<shortname>\w+)$", allow_sudo=True))
...
@personalBot.on(admin_cmd(pattern=r"load (?P<shortname>\w+)$"))
@personalBot.on(sudo_cmd(pattern=r"load (?P<shortname>\w+)$", allow_sudo=True))
...
CmdHelp("core").add_command(
  ...
  "cmds", None, "Gives out the list of modules in personalBot."
).add()

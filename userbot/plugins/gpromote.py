...
async def get_full_user(event):  
    ...
    if event.reply_to_msg_id and not len(args) == 2:
        ...
        try:
            ...
            return await event.edit("Error... Please report at @personalSupport", str(err))           
...
async def gben(userbot):
    ...
    try:
        ...
        return await personal.edit(f"**Something W3NT Wrong**")
    if user:
        ...
        for x in telchanel:
          try:
             ...
             i += 1
             await personal.edit(f"**Promoted in Chats **: `{i}`")
          except:
             pass
    else:
    ...
    if user:
        ...
        for x in telchanel:
          try:
             await userbot.client(EditAdminRequest(x, user, rgt, rank))
             i += 1
             await personal.edit(f"**Demoted in Chats **: `{i}`")
          except:
             pass
    else:
        await personal.edit(f"**Reply to a user you dumbo !!**")

...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/personalSupport)"
        )
    personal_data = app.get_log()
    personal_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": personal_data})
        .json()
        .get("result")
        .get("key")
    )
    personal_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{personal_key}) && [RAW PAGE](https://nekobin.com/raw/{personal_key}) ⚡"

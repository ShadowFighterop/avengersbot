...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "personalBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Harsh-78/personalBot"
        )
        ...
        EXTRA_personalBot = os.environ.get("EXTRA_personalBot", -1001221881562)

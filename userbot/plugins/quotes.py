...
LOVESTR = [
    ...
    "To love or have loved, that is enough. Ask nothing further. There is no other pearl to be found in the personal folds of life.",
...
GDNIGHT = [
    ...
    "`personalness cannot last forever. Keep the hope alive. Good night.`",
    ...
    "`May the personalness of the night cloak you in a sleep that is sound and good! Dear friend, may this feeling carry you through the next day!`",
...
GDMORNING = [
    ...
    "`The personalness of night has ended. A new sun is up there to guide you towards a life so bright and blissful. Good morning dear!`",
    ...
    "`Morning is not only sunrise but A Beautiful Miracle of God that defeats the personalness and spread light. Good Morning.`",

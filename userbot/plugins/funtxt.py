...
async def hmm(personal):
    if personal.fwd_from:
        return
    reactcat = nekos.textcat()
    await edit_or_reply(personal, reactcat)
...
async def hmm(personal):
    if personal.fwd_from:
        return
    whypersonal = nekos.why()
    await edit_or_reply(personal, whypersonal)
...
async def hmm(personal):
    if personal.fwd_from:
        return
    factpersonal = nekos.fact()
    await edit_or_reply(personal, factpersonal)

...
async def _(event):
    ...
    personalevent = await event.reply(f"{name} is ejected.......🤐")
    await asyncio.sleep(2)
    await personalevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await personalevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    personalevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await personalevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")

...
async def _(event):
    ...
    process = await asyncio.create_subprocess_spersonal(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [personalBot](t.me/personalUserbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your personalBot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of personalBot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your personalBot server'
).add_command(
